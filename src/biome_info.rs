...
pub fn biome_name(biome_id: i32) -> Option<&'static str> {
    use biome_id::*;
    let name = match biome_id {
        ocean => "Ocean",
        plains => "Plains",
        desert => "Desert",
        ...
        icePlains => "Snowy Tundra",
        iceMountains => "Snowy Mountains",
        ...
        extremeHillsEdge => "Mountain Edge",
        jungle => "Jungle",
        jungleHills => "Jungle Hills",
        jungleEdge => "Jungle Edge",
        deepOcean => "Deep Ocean",
        stoneBeach => "Stone Shore",
        coldBeach => "Snowy Beach",
        birchForest => "Birch Forest",
        birchForestHills => "Birch Forest Hills",
        roofedForest => "Dark Forest",
        coldTaiga => "Snowy Taiga",
        coldTaigaHills => "Snowy Taiga Hills",
        megaTaiga => "Giant Tree Taiga",
        megaTaigaHills => "Giant Tree Taiga Hills",
        extremeHillsPlus => "Wooded Mountains",
        savanna => "Savanna",
        savannaPlateau => "Savanna Plateau",
        mesa => "Badlands",
        mesaPlateau_F => "Wooded Badlands Plateau",
        mesaPlateau => "Badlands Plateau",
        skyIslandLow => "Small End Islands",
        skyIslandMedium => "End Midlands",
        skyIslandHigh => "End Highlands",
        skyIslandBarren => "End Barrens",
        warmOcean => "Warm Ocean",
        lukewarmOcean => "Lukewarm Ocean",
        coldOcean => "Cold Ocean",
        warmDeepOcean => "Deep Warm Ocean",
        lukewarmDeepOcean => "Deep Lukewarm Ocean",
        coldDeepOcean => "Deep Cold Ocean",
        frozenDeepOcean => "Deep Frozen Ocean",
        127 => "The Void",
        ...
        tallBirchForest => "Tall Birch Forest",
        tallBirchHills => "Tall Birch Hills",
        darkForestHills => "Dark Forest Hills",
        snowyTaigaMountains => "Snowy Taiga Mountains",
        giantSpruceTaiga => "Giant Spruce Taiga",
        giantSpruceTaigaHills => "Giant Spruce Taiga Hills",
        modifiedGravellyMountains => "Gravelly Mountains+",
        shatteredSavanna => "Shattered Savanna",
        shatteredSavannaPlateau => "Shattered Savanna Plateau",
        erodedBadlands => "Eroded Badlands",
        modifiedWoodedBadlandsPlateau => "Modified Wooded Badlands Plateau",
        modifiedBadlandsPlateau => "Modified Badlands Plateau",
        bambooJungle => "Bamboo Jungle",
        bambooJungleHills => "Bamboo Jungle Hills",
        174 => "DripstoneCaves",
        175 => "FrozenPeaks",
        176 => "Grove",
        177 => "JaggedPeaks",

...
mod tests {
    ...
    fn extend_48_to_64() {
        ...
        assert_eq!(&Rng::extend_long_48(131291916928825), &[-1095369317440944327]);
        assert_eq!(&Rng::extend_long_48(249127199878301), &[5773582374512143517, -166384059012830051]);
        assert_eq!(&Rng::extend_long_48(186701866325681), &[3353398099420370609, -2586568334104602959]);
    }
}

...
mod tests {
    ...
    #[test]
    fn extend_48_to_64() {
        assert_eq!(&extend_long_48(132607203138509), &[4400149443144113101]);
        assert_eq!(&extend_long_48(113453751637441), &[6895687433209288129, 955720999684314561]);
        assert_eq!(&extend_long_48(18021957452394), &[3640896845709787754]);
        assert_eq!(&extend_long_48(131291916928825), &[-1095369317440944327]);
        assert_eq!(&extend_long_48(249127199878301), &[5773582374512143517, -166384059012830051]);
        assert_eq!(&extend_long_48(186701866325681), &[3353398099420370609, -2586568334104602959]);
    }
}
